...
export const retrievalQuestions: RetrievalEvaluationCase[] = [
  ...
  { category: "Research focus", question: "How are his EEG projects related?", expectedAnyOf: ["research-trace-eeg-foundation-model", "research-cbra-mod-fine-tuning", "research-backbone-informed-adapters"] },
  { category: "Research focus", question: "What research involves provenance?", expectedAnyOf: ["research-clinical-transition-notes"] },
  ...
  { category: "Publications", question: "Tell me about MultiFinBen.", expectedAnyOf: ["research-multifinben", "publication-multifinben-acl"] },
  ...
  { category: "Research concepts", question: "What are his foundation model projects?", expectedAnyOf: ["research-trace-eeg-foundation-model", "research-cbra-mod-fine-tuning", "research-backbone-informed-adapters"] },
